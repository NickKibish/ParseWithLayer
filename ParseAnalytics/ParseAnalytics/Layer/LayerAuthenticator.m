...
#import "LayerAuthenticator.h"

@implementation LayerAuthenticator

- (BOOL)authenticate {
    NSURL *appID = [NSURL URLWithString:@"layer:///apps/staging/48c2f66a-71c2-11e5-b77d-f95800000e96"];
